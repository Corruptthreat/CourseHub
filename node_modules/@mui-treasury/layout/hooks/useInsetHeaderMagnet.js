...
exports["default"] = exports.useInsetHeaderMagnet = void 0;
...
var useInsetHeaderMagnet = function useInsetHeaderMagnet(sidebarId) {
  ...
  var sidebarConfig = (0, _utils.pickNearestBreakpoint)(insetSidebar.configMapById[sidebarId], screen);
  ...
  var shouldUpdate = resizedHeight && headerConfig.position === 'relative' && (0, _sidebarChecker.isFixedInsetSidebarConfig)(sidebarConfig) && sidebarConfig.headerMagnetEnabled;
...
var _default = useInsetHeaderMagnet;
