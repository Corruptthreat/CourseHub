...
var useInsetSidebar = function useInsetSidebar(id) {
  ...
  return {
    ...
    rootStyles: (0, _deepmerge["default"])((0, _utils.createBreakpointStyles)(root, breakpoints), hiddenRootStyles),
    bodyStyles: (0, _deepmerge["default"])((0, _utils.createBreakpointStyles)(body, breakpoints), hiddenBodyStyles)
  };
};
