...
var _default = function _default(styled) {
  ...
  var StyledSwipeableDrawer = styledProxy(_SwipeableDrawer["default"], _SharedSidebar.CLS);
  var EdgeHeaderOffset = (0, _EdgeHeaderOffset["default"])(styled);
  var TemporarySwipeableDrawer = (0, _SharedSidebar.createSwipeableVariant)('temporary', StyledSwipeableDrawer);
  var PermanentSwipeableDrawer = (0, _SharedSidebar.createSwipeableVariant)('permanent', StyledSwipeableDrawer);
  var PersistentSwipeableDrawer = (0, _SharedSidebar.createSwipeableVariant)('persistent', StyledSwipeableDrawer);
  ...
  var SwipeableSidebar = function SwipeableSidebar(_ref) {
    ...
    var _useSidebar = (0, _hooks.useSidebar)(sidebarId, 'SwipeableDrawer'),
