...
var _EdgeHeaderOffsetCompiler = _interopRequireDefault(require("../../compilers/EdgeHeaderOffsetCompiler"));
...
var _default = function _default(styled) {
  ...
  var EdgeHeaderOffset = function EdgeHeaderOffset(_ref) {
    ...
    var compiler = (0, _EdgeHeaderOffsetCompiler["default"])(data.edgeSidebar, data.header);
    var styles = (0, _utils.createBreakpointStyles)(compiler.getResultStyle(sidebarId), breakpoints);
    var inlineStyle = (0, _hooks.useEdgeHeaderMagnet)(sidebarId);
    return /*#__PURE__*/_react["default"].createElement(Div, {
      className: (0, _clsx["default"])("EdgeHeaderOffset", transition.smooth),
