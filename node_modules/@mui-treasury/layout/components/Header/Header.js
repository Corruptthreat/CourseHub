...
var _HeaderCompiler = _interopRequireDefault(require("../../compilers/HeaderCompiler"));
...
var _default = function _default(styled) {
  ...
  var StyledAppBar = styledProxy(_AppBar["default"]);
  ...
  var Header = function Header(props) {
    ...
    var styles = (0, _utils.createBreakpointStyles)((0, _HeaderCompiler["default"])(state, data.header, data.edgeSidebar).getResultStyle(), breakpoints);
    return /*#__PURE__*/_react["default"].createElement(StyledAppBar, _extends({
      color: 'default',
      elevation: 0,
