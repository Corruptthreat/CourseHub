...
export declare type PersistentBehavior = "fit" | "flexible" | "none";
export declare type DrawerAnchor = "left" | "right";
export declare type SidebarProperties = {
    anchor: DrawerAnchor;
};
...
export declare type Position = "relative" | "sticky" | "absolute" | "fixed";
