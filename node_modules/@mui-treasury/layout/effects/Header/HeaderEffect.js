...
var _default = function _default(header) {
  ...
  var isObjectClipped = function isObjectClipped(sidebarId) {
    return typeof header.clipped === 'boolean' && header.clipped || _typeof(header.clipped) === 'object' && (0, _utils.get)(header, ['clipped', sidebarId]);
  };

  return {
    id: (0, _utils.get)(header, 'id'),
    getHeaderZIndex: function getHeaderZIndex(theme) {
      return isAboveSomeSidebars ? incrementZIndex(theme, 10) : undefined;
    },
    getEdgeSidebarZIndex: function getEdgeSidebarZIndex(sidebarId, theme) {
      return isAboveSomeSidebars && !isObjectClipped(sidebarId) ? incrementZIndex(theme, 20) : undefined;
    },
    isObjectClipped: isObjectClipped
  };
};
